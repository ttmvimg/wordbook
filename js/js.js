...
//菜单闭合
var expand ="<i class=\"fa fa-caret-down\"><\/i>";
var collapse = "<i class=\"fa fa-caret-down\"><\/i>";
$( '.nav_zk .menu-item-has-children > a' ).after( '<button class="dropdown-toggle" >' + expand + '</button>' );
